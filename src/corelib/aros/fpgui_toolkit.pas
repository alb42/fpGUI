...
uses  
  ...
  fpg_stringutils, fpg_utils, fpg_widget, fpg_wuline, fpg_impl, fpg_aros, 
  fpg_animation, fpg_basegrid, 
  ...
  U_Command, U_Pdf, U_Report, U_ReportImages, U_Visu, 
  fpg_dbugintf, fpg_dbugmsg, fpg_style_carbon, fpg_style_plastic, fpg_style_win8,
  fpg_toggle, fpg_scrollframe,fpg_StringGridBuilder, fpg_CSVParser;
